...
import { DisplayFlight, ProcessFlightAdd, AddPassanger, UpdatePassangerDetails, GetPassngerDetailsId, ProcessTicketDelete, GetFlightsDetailsById, GetTicketList } from '../Controllers/flight';
